...
func TestUI_29_ManageResourceLinks(t *testing.T) {
	tests.RunUITest(t, "Admin Manage Resource External Links Workflow", func(t *testing.T, page *ui.Page) {
		cfg := tests.GlobalConfig

		// Initialize Admin Persona and Result collector
		admin := actions.NewAdminPersona(page, cfg.UiURL, 5*time.Second)
		result := actions.NewResult("TestUI_29_ManageResourceLinks")
		...
		actions.ManageResourceExternalLink(admin, cfg, result)
